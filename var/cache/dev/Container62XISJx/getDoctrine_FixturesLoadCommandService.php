...
$a->addFixtures(array(0 => new \App\DataFixtures\AppFixtures(($this->services['security.password_encoder'] ?? $this->load(__DIR__.'/getSecurity_PasswordEncoderService.php')))));
