...
$a->setNamespace('sf_orm_default_73a99c7683483b723d316d793687211ae6125b5bc4b34236d58cd076b1f4d5cf');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_73a99c7683483b723d316d793687211ae6125b5bc4b34236d58cd076b1f4d5cf');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_73a99c7683483b723d316d793687211ae6125b5bc4b34236d58cd076b1f4d5cf');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ActionRepository' => function () {
    return ($this->privates['App\Repository\ActionRepository'] ?? $this->load(__DIR__.'/getActionRepositoryService.php'));
}, 'App\\Repository\\CarteRepository' => function () {
    return ($this->privates['App\Repository\CarteRepository'] ?? $this->load(__DIR__.'/getCarteRepositoryService.php'));
    ...
    return ($this->privates['App\Repository\UtilisateurRepository'] ?? $this->load(__DIR__.'/getUtilisateurRepositoryService.php'));
}))));
